"""
This training steps are attributed to my mentor's code: 
https://github.com/BIGBALLON/distribuuuu/blob/master/distribuuuu/trainer.py
"""
import os
import time
...
def train_epoch(train_loader, net, criterion, optimizer, scheduler, cur_epoch, rank):
...
def train_model():
    ...
    for epoch in range(start_epoch, cfg.OPTIM.MAX_EPOCH):
        train_epoch(train_loader, net, criterion, optimizer, scheduler, epoch, rank)
